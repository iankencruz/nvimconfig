...
vim.keymap.set('n', '<leader>w=', '<C-w>=', { desc = 'Make all windows equal height and width' })

-- Rotate and move
vim.keymap.set('n', '<leader>wr', '<C-w>r', { desc = 'Rotate windows clockwise' })
vim.keymap.set('n', '<leader>wx', '<C-w>x', { desc = 'Exchange current window with next' })
...
vim.keymap.set('n', '<leader>wt', '<C-w>T', { desc = 'Break window into a new tab' })
